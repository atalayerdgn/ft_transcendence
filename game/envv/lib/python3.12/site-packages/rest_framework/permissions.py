...
class IsAuthenticated(BasePermission):
    ...
    def has_permission(self, request, view):
        return bool(request.user_id and request.user_id.is_authenticated)
...
class IsAdminUser(BasePermission):
    ...
    def has_permission(self, request, view):
        return bool(request.user_id and request.user_id.is_staff)
...
class IsAuthenticatedOrReadOnly(BasePermission):
    ...
    def has_permission(self, request, view):
        return bool(
            ...
            request.user_id and
            request.user_id.is_authenticated
        )
...
class DjangoModelPermissions(BasePermission):
    ...
    def has_permission(self, request, view):
        if not request.user_id or (
                not request.user_id.is_authenticated and self.authenticated_users_only):
            return False
        ...
        return request.user_id.has_perms(perms)
