...
from transandancefirst.usermanagment.views.views import UserManagementHandler, AuthHandler
...
urlpatterns = [
    ...
    path('users/username/', UserManagementHandler.as_view({'get': 'get_user_by_username'}),
         name='get_user_by_username'),
    path('users/email/', UserManagementHandler.as_view({'get': 'get_user_by_email'}), name='get_user_by_email'),
    path('users/create/', UserManagementHandler.as_view({'post': 'create_user'}), name='create_user'),
    path('users/delete/', UserManagementHandler.as_view({'delete': 'delete_user'}), name='delete_user'),
